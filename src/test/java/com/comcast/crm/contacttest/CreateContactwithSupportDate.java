...
public class CreateContactwithSupportDate {
	...
	public static void main(String[] args) throws IOException, InterruptedException 
	{
		...
		//entering support date for start and end
		...
		if(actualStartDate.equals(currentDate)   )
		{
			System.out.println(currentDate+" is displayed as Expected");
		}
		else
		{
			System.out.println(currentDate+" is not displayed as Expected");
		}
