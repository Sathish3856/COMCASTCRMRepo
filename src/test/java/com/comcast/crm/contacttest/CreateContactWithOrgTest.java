...
public class CreateContactWithOrgTest {
	...
	public static void main(String[] args) throws IOException 
	{
		...
		driver.findElement(By.xpath("(//td[contains(.,'Organization Name ')]//img[@src='themes/softed/images/select.gif'])[1]")).click();
		//switch to child window
		webLib.switchNewBrowserTabOnTitle(driver, "module=Contacts");
